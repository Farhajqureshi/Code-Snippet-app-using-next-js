...
export namespace Prisma {
  ...
  */
  ...
  export type SnippetOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "descriptionCode", ExtArgs["result"]["snippet"]>
  ...
  interface SnippetFieldRefs {
    ...
    readonly descriptionCode: FieldRef<"Snippet", 'String'>
  }
  ...
  export type SnippetWhereInput = {
    ...
    descriptionCode?: StringFilter<"Snippet"> | string
  }
  ...
  export type SnippetScalarWhereWithAggregatesInput = {
    ...
    descriptionCode?: StringWithAggregatesFilter<"Snippet"> | string
  }
